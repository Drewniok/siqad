...
def main():
    ...
    cds = generate_random_sidb_layout(charge_distribution_surface_100(), generate_params)
    ...
    hyperparameter_tuning(
        ...
        cds, layout_coordinates_angstrom, number_of_simanneal_simulation_runs_to_determine_tts,

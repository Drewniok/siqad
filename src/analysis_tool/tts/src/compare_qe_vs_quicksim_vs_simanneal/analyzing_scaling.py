...
def generate_layouts(final_number_of_sidbs=25, x_distance=4, y_distance=4):
    """
...
def main():
    ...
    # Check if the CSV file exists to decide whether to write a header
    ...
    for layout_id, lyt in enumerate(layouts, start=1):
        ...
        with open(csv_file_path, mode="a", newline="") as csvfile:
            ...
            if write_header:
                csv_writer.writerow(["Layout ID", "QuickExact Runtime (seconds)", "QuickSim TTS", "SimAnneal TTS"])
